...
//               Welcome to Grey Moon <br /> Employee Onboarding
//             </h1>
//             <p className="text-lg md:text-xl text-indigo-100">
//               Learn about Grey Moon’s culture, policies, and processes with interactive modules, engaging videos, and quizzes.
//             </p>
...
//               {/* <button
//                 onClick={() => navigate("/login")}
//                 className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-100 transition"
//               >
//                 Login
//               </button> */}
//             </div>
...
//         <h2 className="text-3xl font-bold text-center mb-12">Why Grey Moon Onboarding?</h2>
...
//             <p className="text-gray-600">Understand company policies, workflows, and best practices through engaging content and quizzes.</p>
//           </div>
//           <div className="bg-white shadow rounded-lg p-6 text-center hover:scale-105 transition">
//             <h3 className="font-semibold text-xl mb-2">Track Your Progress</h3>
//             <p className="text-gray-600">Monitor your completion of onboarding modules and ensure you’re up to date with Grey Moon’s standards.</p>
//           </div>
//           <div className="bg-white shadow rounded-lg p-6 text-center hover:scale-105 transition">
//             <h3 className="font-semibold text-xl mb-2">Certification</h3>
//             <p className="text-gray-600">Complete the final quiz to demonstrate your understanding and get certified in Grey Moon’s onboarding program.</p>
//           </div>
//         </div>
//       </section>
...
//             Join your fellow Grey Moon employees in exploring company culture, policies, and workflows—all in one interactive platform.
//           </p>
//           <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow rounded-lg p-6 text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              ...
              up to date with Grey Moon’s standards.
            </p>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-6 text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              ...
              certified in Grey Moon’s onboarding program.
            </p>
          </div>
